...
function CreateSession() {
    ...
    const startTest = async ()=>{
        const res = await fetch(`${("TURBOPACK compile-time value", "http://localhost:8080/api")}/session/test?includeIntegers=${includeIntegers}`, {
            method: 'post'
        });
        if (!res.ok) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4d4f66b4._.js.map